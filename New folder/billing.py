...
style.configure("TLabel", font=("Helvetica", 10), background= "#A7E5E8")
style.configure("TLabelframe.Label", font=("Helvetica", 12, "bold"), background="#A7E5E8")
style.configure("TLabelframe", background= "#A7E5E8", padding=5)

# Create and configure widgets directly on the root window

# Patient Information Section
patient_info_frame = ttk.LabelFrame(root, text="Patient Information", padding=(10, 5))
patient_info_frame.grid(row=0, column=0, padx=10, pady=10, sticky="ew")
...
# Charges Section
charges_frame = ttk.LabelFrame(root, text="Charges", padding=(10, 5))
charges_frame.grid(row=1, column=0, padx=10, pady=10, sticky="ew")
...
# Insurance Section
insurance_frame = ttk.LabelFrame(root, text="Insurance", padding=(10, 5))
insurance_frame.grid(row=2, column=0, padx=10, pady=10, sticky="ew")
...
calculate_button.grid(row=3, column=0, pady=10, padx=10, sticky="ew")

# Total Bill Label
total_charge_label = ttk.Label(root, text="Total Bill --")
total_charge_label.grid(row=4, column=0, padx=10, pady=10)

# Generate Invoice Button
generate_button = ttk.Button(root, text="Generate Invoice", command=generate_invoice)
generate_button.grid(row=5, column=0, pady=10, padx=10, sticky="ew")
