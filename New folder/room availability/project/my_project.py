...
def addAppointment():
    ...
    # Patient name
    tk.Label(appointment_form, text="Patient Name:").grid(row=0, column=0, padx=10, pady=10, sticky='w')
    ...
    # Doctor name
    tk.Label(appointment_form, text="Doctor Name:").grid(row=1, column=0, padx=10, pady=10, sticky='w')
    ...
    # Date
    tk.Label(appointment_form, text="Date:").grid(row=2, column=0, padx=10, pady=10, sticky='w')
    date_entry = DateEntry(appointment_form, selectmode='day', date_pattern='yyyy-mm-dd')
    date_entry.grid(row=2, column=1, padx=10, pady=10)
    
    # Time
    tk.Label(appointment_form, text="Time:").grid(row=3, column=0, padx=10, pady=10, sticky='w')
    ...
    # Purpose
    tk.Label(appointment_form, text="Purpose:").grid(row=4, column=0, padx=10, pady=10, sticky='w')
...
appointment_tree.grid(row=0, column=0, columnspan=2, padx=10, pady=10, sticky='nsew')
top.grid_rowconfigure(0, weight=1)
top.grid_columnconfigure(0, weight=1)
top.grid_columnconfigure(1, weight=1)

# Add and Delete Appointment Buttons
ttk.Button(top, text="Add Appointment", command=addAppointment).grid(row=1, column=0, pady=20)
ttk.Button(top, text="Delete Appointment", command=deleteAppointment).grid(row=1, column=1, pady=20)
